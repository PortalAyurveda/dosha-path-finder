...
export const dravyaGunaData: CourseData = {
  meta: {
  ...
  hero: {
    headline: "Pare de tratar sintomas.\nComece a cuidar da sua saúde.",
    subheadline:
      "Não dependa mais de importar erva indiana. Aprenda a usar a erva brasileira.",
    description:
      "Aprenda o segredo da alquimia ayurvédica e construa seus próprios remédios, com base na herbologia ancestral, levando em conta o seu dosha e a sua individualidade.",
    priceOld: "",
    priceNew: "R$ 697",
  ...
  problem: {
    title: "Você trata o sintoma.\nE o sintoma sempre volta.",
    intro:
      "Você toma o remédio quando a dor aparece. A dor passa. Depois volta. Você troca de farmácia, troca de marca, testa o chá que a vizinha indicou.\n\nE continua sem entender por que aquilo funciona, quando funciona, e por que às vezes não funciona nada.",
    bullets: [
      "Toma chá ou tintura sem saber a dose certa, nem o efeito real no seu corpo",
      "Depende de indicação de grupo de WhatsApp, ou de vídeo solto na internet",
      "Compra erva importada da Índia sem saber se existe uma versão brasileira que funciona igual, ou melhor",
      "Não sabe se aquele remédio caseiro, na dose errada, é remédio ou é veneno",
      "Quer cuidar da própria família, ou dos próprios pacientes, e trava na primeira dúvida",
    ],
    closing: "O problema não é falta de vontade. É falta de método.",
    examples: [
      "A mesma erva que ajuda o seu vizinho pode fazer mal para você, e ninguém te explicou o motivo.",
      "Você decora a receita, mas não aprende o porquê dela. Na próxima vez que os sintomas mudarem, você trava de novo.",
    ],
    finalNote:
      "Isso não é falta de sorte. É falta de entender a alma da planta, o Dravya Guna.",
  },
  opportunity: {
    title: "Esse conhecimento é raro no Brasil.\nQuase ninguém formula com erva brasileira.",
    paragraphs: [
      "A maior parte do que se ensina de fitoterapia ayurvédica no Brasil depende de erva importada da Índia. Cara, difícil de achar, e nem sempre a versão certa chega até você.",
      "Há mais de 10 anos formulando remédios ayurvédicos para pacientes, o professor Edson Osorio construiu o caminho inverso: usar a erva brasileira ao lado da indiana, aplicando a mesma lógica de formulação nas duas.",
      "A ANVISA regula o que pode e o que não pode virar remédio no Brasil. Isso não é um obstáculo para você contornar, é o motivo pelo qual você precisa aprender com responsabilidade e fundamento, não com achismo de grupo de WhatsApp.",
    ],
    highlight:
      "Você não precisa esperar uma encomenda vinda de fora do país. A resposta pode estar na sua horta, ou na farmácia mais perto de casa.",
    closing: "Só falta você aprender a lógica por trás de cada planta.",
  },
  solution: {
    title: "Depois desse curso, você não chuta mais dose nem combinação.",
    description:
      "Você vai entender por que a mesma erva age diferente em corpos diferentes. Vai saber o veículo certo pra tomar cada remédio, a dose certa, e a hora certa. Isso é Dravya Guna: a alma da planta, aplicada ao seu corpo, ao corpo do seu paciente, à sua família.\n\nVocê deixa de depender de fórmula pronta e passa a criar a sua.",
    benefits: [
      {
        iconName: "BookOpen",
        title: "Fundamentos que sustentam tudo",
        text: "Os 3 doshas, a fisiologia do corpo, o Agni e o Ama. Antes de qualquer receita, você entende como o corpo processa o que recebe.",
      },
      {
        iconName: "Sprout",
      ...
      {
        iconName: "Target",
        title: "Autonomia pra formular",
        text: "Óleos e ghee medicados, xaropes, pós, tinturas. Você aprende a criar seus próprios remédios, não só a copiar receita pronta.",
      },
    ],
  },
  modules: {
    title: "O caminho, em 3 camadas: da base até a prática",
    modules: [
      {
        number: 1,
  ...
  professor: {
    ...
    bio: [
      ...
      "Dezenas de pessoas e centenas de terapeutas já passaram por esse curso pra criar suas próprias fórmulas. Muitas empresas nasceram daqui.",
    ],
  },
  finalCta: {
