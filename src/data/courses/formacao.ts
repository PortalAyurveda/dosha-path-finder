...
export const formacaoData: FormacaoData = {
  ...
  programa: {
    ...
    intro:
      "Ao longo de 1 ano e meio, você vai percorrer os 15 módulos que te transformam de praticante em terapeuta profissional. Mas isso vai muito além das aulas ao vivo.",
