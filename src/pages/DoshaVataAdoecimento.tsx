...
const DoshaVataAdoecimento = () => {
  return (
    <>
      <DoshaSelector />
      <Helmet>
        <title>Adoecimento de Vata — Fisiopatologia Avançada | Portal Ayurveda</title>
      ...
      <DoshaSection icon="⚙️" title="Patologia dos 5 Ventos (Subdoshas)">
        <div className="space-y-5">
          <AdoecimentoSubdoshaCard
            number={1}
            name="Prana Vayu"
            subtitle="Sede Original do Distúrbio"
            tagline="Mente / Intelecto"
            description="Quando o vento que rege a percepção de fora para dentro adoece, a mente perde o eixo. É aqui que nascem as doenças psicossomáticas graves e as psicoses."
            mixEffects={[
          ...
          <AdoecimentoSubdoshaCard
            number={2}
            name="Udana Vayu"
            subtitle="Alvo: Garganta e Cordas Vocais"
            tagline="Expressão / Tireoide"
            description="O adoecimento do vento ascendente sufoca a expressão do Ser. Ele ofusca o paciente ou o faz exacerbar o mecanismo da fala."
            mixEffects={[
          ...
          <AdoecimentoSubdoshaCard
            number={3}
            name="Samana Vayu"
            subtitle="Alvo: Intestino Delgado e Estômago"
            tagline="Agni / Trato Digestivo"
            description="A quebra deste vento destrói o Jatar Agni. O alimento é movimentado de forma errática, perdendo a capacidade de separação nutricional."
            mixEffects={[
          ...
          <AdoecimentoSubdoshaCard
            number={4}
            name="Apana Vayu"
            subtitle="O Grande Vilão de Vata"
            tagline="Excreção / Pelve"
            description='É a raiz sistêmica do adoecimento. Um cólon intoxicado e "enfezado" reverte os ventos, empurrando Ama de volta para o sangue.'
            mixEffects={[
          ...
          <AdoecimentoSubdoshaCard
            number={5}
            name="Vyana Vayu"
            subtitle="Alvo: Tecido Sanguíneo e Cardíaco"
            tagline="Circulação / Coração"
            description='Quando o vento distribuidor perde a nutrição, o coração gira "no vazio", esgotando o Ojas (vitalidade) e a imunidade.'
            mixEffects={[
