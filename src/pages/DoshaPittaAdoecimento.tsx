...
const DoshaPittaAdoecimento = () => {
  return (
    <>
      <DoshaSelector />
      <Helmet>
        <title>Dosha Pitta e Subdoshas — Avançado | Portal Ayurveda</title>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-pitta/10 via-background to-pitta/5 py-12 md:py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center space-y-4">
          ...
          <h1 className="font-serif text-3xl md:text-4xl font-bold text-primary">
            Dosha Pitta e Subdoshas — Avançado
          </h1>
      ...
      <DoshaSection icon="🔬" title="Patologia dos 5 Fogos (Subdoshas)">
        <div className="space-y-5">
          ...
          <AdoecimentoSubdoshaCard number={4} name="Alochaka Pitta" subtitle="Alvo: Sistema Ocular e Percepção" tagline="A Visão e os Olhos" description='O excesso do calor nos olhos. Em desequilíbrio, a visão "queima" quem vê e quem é visto. O indivíduo torna-se intolerante ao diferente.' mixEffects={[
