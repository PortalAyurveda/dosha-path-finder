...
const RULES: Record<AbaDosha, RuleMeta[]> = {
  geral: [
    {
      id: "R13",
      titulo: "Vata lidera o colapso digestivo",
      insight: "Quando a digestão é caótica, é Vata que aparece em primeiro lugar.",
    },
    {
      id: "R09",
      titulo: "Bomba relógio: score crítico + Agni Irregular",
      insight: "Desequilíbrio total somado a digestão irregular.",
    },
    {
      id: "R37",
      titulo: "Vata adoece antes de Pitta",
      insight: "Vata Adoecido enquanto Pitta ainda está só em acúmulo.",
    },
    { id: "R07", titulo: "Pitta Fixado já contaminou Vata", insight: "Quando Pitta fixa, Vata já está comprometido." },
    {
      id: "R33",
      titulo: "Inflamação acumulando dos 13 aos 49",
      insight: "Metade dos jovens e adultos já acumula Pitta.",
    },
    {
      id: "R22",
      titulo: "Fase Vata da vida: 50+ com Agni Irregular",
      insight: "A digestão começa a falhar com a idade.",
    },
    {
      id: "R49",
      titulo: "Dieta dos 3 doshas = score 36 pontos maior",
      insight: "Comer de tudo não equilibra — descompensa.",
    },
    {
      id: "R47",
      titulo: "Paradoxo: Vata Fixado com Agni Forte",
      insight: "Combinação clínica raríssima — quase incompatível.",
    },
    {
      id: "R48",
      titulo: "Paradoxo: IMC magro com Agni Fraco",
      insight: "Magro não é Kapha. Combinação praticamente inexistente.",
    },
  ],
  vata: [
    {
      id: "R03",
      titulo: "Agni Irregular nível 3 → Vata Adoecido",
      insight: "Quase uma regra absoluta. 98.7% adoecem.",
    },
    {
      id: "R44",
      titulo: "Vata Normal já tem Agni Irregular",
      insight: "Sinal precoce: o desequilíbrio começa antes do score subir.",
    },
    ...
    {
      id: "R17",
      titulo: "Vata Fixado evita alimentos Pitta",
      insight: "Falta calor pra equilibrar o vento — só piora.",
    },
    { id: "R21", titulo: "Vata Acúmulo evita alimentos Pitta", insight: "Padrão alimentar que antecede o colapso." },
    {
      id: "R39",
      titulo: "Vata Fixado com 5+ sintomas Pitta",
      insight: "Vento que pegou fogo. O Vata contaminou Pitta.",
    },
    {
      id: "R41",
      titulo: "Vata Adoecido → Pitta Acúmulo",
      insight: "Progressão natural Vata → Pitta. 41.6% seguem o caminho.",
    },
    {
      id: "R40",
      titulo: "50+ com Vata Adoecido",
      insight: "Quase metade dos mais velhos já chegou no estágio crítico.",
    },
  ],
  pitta: [
    {
      id: "R04",
      titulo: "Agni Forte nível 3 → Pitta Adoecido",
      insight: "Fogo intenso demais queima o próprio dosha.",
    },
    {
      id: "R02",
      titulo: "Pitta Fixado sem Agni Forte = Agni Irregular",
      insight: "Pitta fixado tem digestão caótica, não força.",
    },
    {
      id: "R06",
      titulo: "Pitta Fixado sem Agni Forte → Vata Adoecido",
      insight: "Inflamação com raiz em Vata. 83.8% mostram esse padrão.",
    },
    {
      id: "R10",
      titulo: "Tríade destrutiva: Pitta Fixado + Vata Adoecido + Agni Irregular",
      insight: "Quando os três se somam, o quadro vira complexo.",
    },
    {
      id: "R11",
      titulo: "Pitta Fixado com 5+ sintomas Vata: burnout",
      insight: "O fogo que esgota o vento — padrão de exaustão.",
    },
    {
      id: "R26",
      titulo: "Agni Forte nível 2 + Pitta Adoecido → Vata Acúmulo",
      insight: "Fogo médio-alto já contamina Vata.",
    },
    {
      id: "R46",
      titulo: "Pitta oculto: score normal + 4+ sintomas",
      insight: "Quase 1 em 4 tem Pitta escondido nos sintomas.",
    },
    { id: "R30", titulo: "Pitta Acúmulo evita alimentos Vata", insight: "Falta leveza pra resfriar o fogo." },
    {
      id: "R34",
      titulo: "Pitta Pouco sem Agni Forte: dieta apaga o fogo",
      insight: "Apagando o fogo que já era fraco — espiral pra baixo.",
    },
  ],
  kapha: [
    ...
    {
      id: "R12",
      titulo: "Kapha Acúmulo + 5+ sintomas Vata",
      insight: "Corpo pesado, mente dispersa: o paradoxo Kapha.",
    },
    {
      id: "R25",
      titulo: "Tripla confirmação Kapha: IMC alto + Agni Fraco + 4 sintomas",
      insight: "Quando os três se somam, o diagnóstico fecha.",
    },
    { id: "R23", titulo: "Kapha Acúmulo evita alimentos Pitta", insight: "Falta fogo pra queimar a estagnação." },
    {
      id: "R19",
      titulo: "6+ sintomas Kapha + dieta pobre em Pitta",
      insight: "Sintomas gritando, dieta não responde.",
    },
    {
      id: "R27",
      titulo: "Agni Fraco + Kapha Acúmulo → Pitta Normal ou abaixo",
      insight: "Kapha e Pitta não convivem bem no alto.",
    },
    {
      id: "R28",
      titulo: "IMC alto + Agni Fraco evita alimentos Vata",
      insight: "Sem leveza, sem movimento, sem saída.",
    },
      ...
      >
        ...
        <div className="flex items-end gap-1 md:gap-1.5" style={{ height: 240 }}>
          {temporal.map((d, i) => {
            ...
            return (
              <div key={d.dia} className="flex-1 flex flex-col items-center gap-1 group min-w-0">
                <span
  ...
  return (
    <div style={{ background: C.bg, minHeight: "100vh" }}>
      <Helmet>
        ...
        <meta
          name="description"
          content="Dados em tempo real de milhares de diagnósticos ayurvédicos: padrões de Vata, Pitta, Kapha e insights da IA Akasha."
        />
