...
const Assinar = () => {
  ...
  const { data: cardReceita } = useQuery({
    queryKey: ["assinar-card-receita", itemParam],
    queryFn: async () => {
      ...
      const { data } = await supabase
        ...
        .eq("id", itemParam)
        .maybeSingle();
      return (data as { id: string; titulo: string | null; imagem_url: string | null; nugget_json: any } | null) ?? null;
    },
    staleTime: 5 * 60 * 1000,
  });
        ...
        <section style={{ background: SURFACE }}>
          <div className="max-w-[1040px] mx-auto px-4 sm:px-6 py-6 md:py-8">
              ...
              >
                ...
                <div className="p-3">
                  ...
                  <div style={{ fontFamily: "'DM Sans', sans-serif" }}>
                    <ClinicalThermometer doshaScores={exemploScores} variant="compact" />
                  </div>
            ...
            <div>
              ...
              <h3
                className="font-serif italic font-bold text-xl md:text-[22px] text-center mb-3"
                style={{ color: PRIMARY }}
              >
