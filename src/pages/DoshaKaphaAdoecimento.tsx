...
const DoshaKaphaAdoecimento = () => {
  return (
    <>
      <DoshaSelector />
      <Helmet>
        <title>Adoecimento de Kapha — Fisiopatologia Avançada | Portal Ayurveda</title>
      ...
      <DoshaSection icon="⚙️" title="Patologia das 5 Mucosas (Subdoshas)">
        <div className="space-y-5">
          <AdoecimentoSubdoshaCard
            number={1}
            name="Avalambaka Kapha"
            subtitle="A Grande Morada do Excesso"
            tagline="Sustentação / Pulmão"
            description="É a sede onde o Kapha sistêmico armazena seu excesso. O pulmão, em vez de transformar ar em energia, afoga-se nos próprios fluidos."
            mixEffects={[
          ...
          <AdoecimentoSubdoshaCard
            number={2}
            name="Kledaka Kapha"
            subtitle="Alvo: Parede Gástrica e Digestão"
            tagline="A Fleuma do Estômago"
            description="O muco protetor torna-se um pântano. O fogo digestivo (Agni) é completamente apagado por excesso de densidade."
            mixEffects={[
          ...
          <AdoecimentoSubdoshaCard
            number={3}
            name="Tarpaka Kapha"
            subtitle="Alvo: Sistema Nervoso e Emoções"
            tagline="Mente e Bainha de Mielina"
            description="A base sólida da mente congestiona de inércia (Tamas), gerando apegos patológicos e depressão arrastada."
            mixEffects={[
          ...
          <AdoecimentoSubdoshaCard
            number={4}
            name="Bodhaka Kapha"
            subtitle="Alvo: Língua e Papilas"
            tagline="Boca e Fala"
            description="O sabor da vida desaparece, sendo substituído por fome emocional e incapacidade de processar experiências."
            mixEffects={[
          ...
          <AdoecimentoSubdoshaCard
            ...
            subtitle="Alvo: Cápsulas e Juntas"
            tagline="Óleo Articular"
            description="A lubrificação torna-se retenção hídrica massiva para compensar agressões externas."
            mixEffects={[
