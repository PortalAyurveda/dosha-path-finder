...
const ArticleCard = ({ article }: { article: ArticleMock }) => (
  <Card className="rounded-2xl overflow-hidden hover:shadow-lg hover:-translate-y-1 transition-all border border-border">
    ...
    <section className="max-w-6xl mx-auto px-4 sm:px-6 py-16 md:py-24">
      ...
      <Tabs defaultValue="recentes" className="w-full">
        <TabsList className="mx-auto mb-8 flex w-fit">
          ...
          <TabsTrigger value="estilo" className="gap-1.5">
