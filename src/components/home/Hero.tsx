          ...
          <div className="lg:col-span-5 flex flex-col">
            ...
            >
              <div className="text-center not-italic">
                <h1 className="mb-2 text-2xl md:text-3xl font-semibold lg:text-[44px] leading-tight not-italic">
                  Seu guia completo para saúde e longevidade.
                </h1>
                <p className="text-sm md:text-base lg:text-[15px] leading-snug text-muted-foreground not-italic max-w-[26ch] mx-auto">
                  Descubra e cuide dos seus Doshas por meio da<br />medicina milenar.
                </p>
              </div>
